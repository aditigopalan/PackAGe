...
aditi.package::reading_in("C:/Users/aditi/Desktop/angsd/aditi.package/data/fastqc_data.txt")
```
```
...
do
cp ./WT_1_${i}_fastqc/fastqc_data.txt /athena/angsd/scracth/adg4001/data_package/WT_1_${i}_data.txt
done
```
